...
mod1manual <- list(coefficients = betas, Std.Error = c(round(se1,4),round(se2,4)), tvalue = c(round(t1,4),round(t2,4)), p = c(round(p1,4),round(p2,4)))
...
summary(mod)[["coefficients"]][, "Estimate"] - mod1manual$Estimate

summary(mod)[["coefficients"]][, "Std. Error"] - mod1manual$Std.Error

summary(mod)[["coefficients"]][, "t value"] - mod1manual$tvalue

summary(mod)[["coefficients"]][, "Pr(>|t|)"] - mod1manual$p
